...
const ALLOWED_ENTITY_TYPES = Object.freeze(['user', 'ticket', 'asset', 'project', 'project_task', 'project_member', 'vendor', 'knowledge_article', 'license', 'change', 'audit_log', 'dashboard', 'report']);
