...
const TEMPLATE_CONSTANTS = Object.freeze({
  ...
  DESC_TRUNCATION_LEN: constantsModule.DESC_TRUNCATION_LEN,
  PROGRESS_GREEN_THRESHOLD: constantsModule.PROGRESS_GREEN_THRESHOLD,
  PROGRESS_BLUE_THRESHOLD: constantsModule.PROGRESS_BLUE_THRESHOLD,
  PROGRESS_ORANGE_THRESHOLD: constantsModule.PROGRESS_ORANGE_THRESHOLD,
  WORKLOAD_MULTIPLIER: constantsModule.WORKLOAD_MULTIPLIER,
  WORKLOAD_RED_THRESHOLD: constantsModule.WORKLOAD_RED_THRESHOLD,
  WORKLOAD_ORANGE_THRESHOLD: constantsModule.WORKLOAD_ORANGE_THRESHOLD,
  COMMENT_LIST_CAP: constantsModule.COMMENT_LIST_CAP,
  ASSIGNED_ITEMS_CAP: constantsModule.ASSIGNED_ITEMS_CAP,
  TASK_LIST_CAP: constantsModule.TASK_LIST_CAP,
  MEMBER_LIST_CAP: constantsModule.MEMBER_LIST_CAP,
  CONDITION_BADGE: constantsModule.CONDITION_BADGE,
  CHANGE_TYPE_BADGE: constantsModule.CHANGE_TYPE_BADGE,
  ROLE_BADGE: constantsModule.ROLE_BADGE,
  MEMBER_ROLE_BADGE: constantsModule.MEMBER_ROLE_BADGE,
  KB_CATEGORY_BADGE: constantsModule.KB_CATEGORY_BADGE,
  LICENSE_TYPE_BADGE: constantsModule.LICENSE_TYPE_BADGE,
  TICKET_STATUS_BADGE: constantsModule.TICKET_STATUS_BADGE,
  TICKET_PRIORITY_BADGE: constantsModule.TICKET_PRIORITY_BADGE,
  ASSET_STATUS_BADGE: constantsModule.ASSET_STATUS_BADGE,
  PROJECT_STATUS_BADGE: constantsModule.PROJECT_STATUS_BADGE,
  PROJECT_PRIORITY_BADGE: constantsModule.PROJECT_PRIORITY_BADGE,
  TASK_PRIORITY_BADGE: constantsModule.TASK_PRIORITY_BADGE,
  TASK_DEADLINE_BADGE: constantsModule.TASK_DEADLINE_BADGE,
  WARRANTY_DEADLINE_BADGE: constantsModule.WARRANTY_DEADLINE_BADGE,
  CHANGE_STATUS_BADGE: constantsModule.CHANGE_STATUS_BADGE,
...
app.use((req, res, next) => {
  ...
  res.locals.KB_CATEGORY_BADGE = KB_CATEGORY_BADGE;
  res.locals.LICENSE_TYPE_BADGE = LICENSE_TYPE_BADGE;
  res.locals.TICKET_STATUS_BADGE = TICKET_STATUS_BADGE;
  res.locals.TICKET_PRIORITY_BADGE = TICKET_PRIORITY_BADGE;
  res.locals.ASSET_STATUS_BADGE = ASSET_STATUS_BADGE;
  res.locals.PROJECT_STATUS_BADGE = PROJECT_STATUS_BADGE;
  res.locals.PROJECT_PRIORITY_BADGE = PROJECT_PRIORITY_BADGE;
  res.locals.TASK_PRIORITY_BADGE = TASK_PRIORITY_BADGE;
  res.locals.CHANGE_STATUS_BADGE = CHANGE_STATUS_BADGE;
  res.locals.CHANGE_PRIORITY_BADGE = CHANGE_PRIORITY_BADGE;
