...
// ========================
const users = [
  { username: 'admin', password: 'admin123', email: 'admin@company.com', first_name: 'Sarah', last_name: 'Chen', role: 'admin', department: 'IT', phone: '555-0101' },
  { username: 'jwilliams', password: 'staff123', email: 'j.williams@company.com', first_name: 'James', last_name: 'Williams', role: 'manager', department: 'IT', phone: '555-0102' },
  { username: 'mpatel', password: 'staff123', email: 'm.patel@company.com', first_name: 'Maya', last_name: 'Patel', role: 'staff', department: 'IT', phone: '555-0103' },
  { username: 'trodriguez', password: 'staff123', email: 't.rodriguez@company.com', first_name: 'Tomás', last_name: 'Rodriguez', role: 'staff', department: 'IT', phone: '555-0104' },
  { username: 'akimura', password: 'staff123', email: 'a.kimura@company.com', first_name: 'Aiko', last_name: 'Kimura', role: 'staff', department: 'IT', phone: '555-0105' },
  { username: 'dmuller', password: 'staff123', email: 'd.muller@company.com', first_name: 'Dieter', last_name: 'Müller', role: 'staff', department: 'IT', phone: '555-0106' },
];
...
console.log('  Manager:  jwilliams / staff123');
console.log('  Staff:    mpatel / staff123\n');
